...
- Weather & Airspace
- Air Traffic Control
- Navigation & Cockpit Systems
- Aviation Communication
- Flight Planning
- Careers in Aviation & More

## Hands-On Flight Simulation

Students will get time in our flight simulator to practice using a yoke and real controls, build confidence, and get a real feel for takeoffs and landings.

- Practice takeoffs and landings
- Use a yoke and real controls
- Build confidence and coordination
- A great first step toward real flight
...
- **Weather Tracking** — read the sky like a pilot
- **Air Traffic Control Basics** — learn how pilots communicate
- **Cockpit Navigation** — instruments, charts, and systems
- **Flight Planning & Navigation** — chart a course from A to B
- **Certificate of Completion** — earned at the end of the course
...
<div style="display: flex; gap: 1.25rem; align-items: flex-start; margin-top: 1rem;">
  <img src="/headshot-sarah.jpg" alt="Sarah Szakovits" style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover; flex-shrink: 0;" />
  <div>
    <strong>Sarah Szakovits</strong> — Airline Transport Pilot with 13 years of flying experience, including 9 years in the airline industry. Most recently an Airbus A320 pilot for Spirit Airlines, and a passionate homeschool educator who loves inspiring the next generation of aviators.
  </div>
</div>
